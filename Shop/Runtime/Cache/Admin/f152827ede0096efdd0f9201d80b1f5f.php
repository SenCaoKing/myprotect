...
<body style="background: #278296;color:white;">
    <form method="post" action="/index.php/Admin/Login/login" onsubmit="return validate()">
        <table cellspacing="0" cellpadding="0" style="margin-top:100px;" align="center">
            <tr>
                <td>
                    <img src="/Public/Admin/Images/login.png" width="178" height="256" border="0" alt="Sen-shop" />
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2" align="right">
                                <img src="<?php echo ('chkcode');?>" style="cursor:pointer" onclick="this.src='<?php echo U('chkcode') ?>#'+Math.random()" />
                                <a onclick="$(this).prev().trigger('click')" style="cursor:pointer;">看不清？换一张</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="right">
                                <input type="checkbox" value="1" name="remember" id="remember" style="position: relative;top: 3px;" />
