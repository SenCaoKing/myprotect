    ...
    <script type="text/javascript">
        $(function(){
            $("input[type=submit]").click(function(){
                var p_level=$("#s1").find("option:selected").attr("level");
                var pid=$('#s1').val();
...
<!-- 内容主题 -->
    ...
    <div class="main-div">
        ...
        <form style="margin:5px;">
            ...
            <p class="label">模块名称：<input type="text" id="module_name" placeholder="如果没有则填null" /></p>
            <p class="label">控制器名称：<input type="text" id="controller_name" placeholder="如果没有则填null" /></p>
            <p class="label">方法名称：<input type="text" id="action_name" placeholder="如果无方法则填null" /></p>
