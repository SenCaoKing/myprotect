...
class MemberModel extends Model
{
    ...
    // 在会员注册成功之后
    protected function _after_inseert($data, $option)
    {
        // heredoc的语法
        $content =<<<HTML
        <p>欢迎您成为本站会员，请点击以下链接地址完成email验证。<p>
        <p><a href="http://localhost/Shop/index.php/Home/Member/emailchk/code/{$data['email_code']}">点击完成验证</a><p>
HTML;
        // 把生成的验证码发到会员的邮箱中
        sendMail($data['email'], 'Sen网email验证', $content);
    }
    /**
     * 验证用户登陆
     */
